...
# 2026-08-10 — chore/unifica-nombres-release

- Los instaladores públicos de Windows y Linux pasan a usar nombres estables
  compatibles con enlaces `releases/latest/download`, sin cambiar la versión
